...
const Rana Muzamal = {
    pronouns: "He" | "Him",
    code: ["JavaScript"],
    askMeAbout: ["web development", "technology", "application development", "photography"],
    technologies: {
        frontEnd: {
            js: ["React", "Redux", "Next.js"],
            css: ["CSS3", "SASS", "Styled Components", "Bootstrap", "Tailwind CSS", "Chakra UI"]
        },
        backEnd: {
    ...
    architecture: ["Single Page Applications", "Progressive Web Applications", "Microservices"],
